    ...
    return (
        <div className='h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48'>
            ...
            <div className="md:hidden lg:flex  justify-center">
                <Link href="/" className="tx-sm bg-black rounded-md p-1 font-semibold flex items-center justify-center">
                    <span className="text-white mr-1 ml-1">Saifi</span>
                    <span className="w-12 h-8 rounded bg-white text-black flex items-center justify-center">.here</span>
                </Link>
            </div>
            {/* Social */}
            <div className="hidden md:flex gap-4 ">
